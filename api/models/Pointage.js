...
module.exports = {
    ...
    afterCreate: function(pointage, next) {
        sails.sockets.broadcast('PresenceApplication', 'pointage', { verb: 'created', id: pointage.id, data: pointage });
    ...
    afterUpdate: function(pointage, next) {
        ...
        sails.sockets.broadcast('PresenceApplication', 'pointage', { verb: 'updated', id: pointage.id, data: pointage });
        return updateEtat(pointage, next);
    },
